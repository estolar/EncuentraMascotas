...
petlost1 = Petlost.new(name: 'Max', finded: false, breed: 'Labrador Retriever', color: "['Negro']", signs: 'Collar rojo', day_lost: Date.today - 5, user: user1, address: 'Avenida Arequipa 120, Miraflores, Lima')
...
petlost4 = Petlost.new(name: 'Lucy', finded: false, breed: 'Golden Retriever', color: "['Dorado']", signs: 'Pelaje brillante', day_lost: Date.today - 3, user: user4, address: 'Calle Santa Catalina 570, Cercado, Arequipa')
...
petlost5 = Petlost.new(name: 'Buddy', finded: false, breed: 'Pug', color: "['Blanco']", signs: 'Pequeño tamaño', day_lost: Date.today - 12, user: user5, address: 'Calle Santa Catalina 320, Cercado, Arequipa')
...
petfound1 = Petfound.new(details: "Lo vi cerca de la avenida y se veía perdido", breed: 'Labrador Retriever', color: "['Negro']", signs: 'Tenia algo rojo en el cuello', day_found: Date.today - 5, user: user1, address: 'Avenida Arequipa 1234, Miraflores, Lima', facts: "le estoy dando refugio! :)")
...
petound2 = Petfound.new(details: "Estaba asustado y corriendo", breed: 'Beagle', color: "['Marrón', 'blanco']", signs: 'Era pequeño', day_found: Date.today - 10, user: user2, address: 'Avenida Arequipa 230, Miraflores, Lima', facts: "solo lo vi mientras pasaba :(")
...
petfound3 = Petfound.new(details: "Estaba durmiendo", breed: 'Otros', color: "['Gris']", signs: 'Cojeaba un poco', day_found: Date.today - 7, user: user3, address: 'Avenida Javier Prado 940, Surco, Lima', facts: "solo lo vi mientras pasaba :(")
...
petfound4 = Petfound.new(details: "Estaba corriendo todo el rato y se fue para el sur", breed: 'Golden Retriever', color: "['Dorado']", signs: 'Pelo largo y brillante', day_found: Date.today - 3, user: user4, address: 'Calle Santa Catalina, Cercado, Arequipa', facts: "Otras circunstancias")
...
petfound5 = Petfound.new(details: "Estaba durmiendo en acera", breed: 'Otros', color: "['Blanco']", signs: 'Pequeño', day_found: Date.today - 12, user: user5, address: 'Calle Santa Catalina 120, Cercado, Arequipa', facts: "le estoy dando refugio! :)")
